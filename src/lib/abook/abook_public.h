...
namespace abook_qt {
  extern std::function<void(std::string)> func_avatarChangedSignal;
  extern std::function<void(std::vector<std::shared_ptr<AbookContact>>)> func_contactsChangedSignal;
  extern std::function<void()> func_initReadySignal;
  extern bool AGGREGATOR_READY;
